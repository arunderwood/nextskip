...
class ContestICalDtoTest {
    ...
    void testValidate_NullSummary() {
        ...
        assertEquals("Contest summary (name) is required", ex.getMessage());
    }

    @Test
    void testValidate_BlankSummary() {
        Instant start = Instant.now();
        Instant end = start.plus(24, ChronoUnit.HOURS);
    ...
    @Test
    void testValidate_EmptySummary() {
        Instant start = Instant.now();
        Instant end = start.plus(24, ChronoUnit.HOURS);
    ...
    @Test
    void testValidate_EndBeforeStart() {
        Instant start = Instant.now();
    ...
    @Test
    void testValidate_EndEqualsStart() {
