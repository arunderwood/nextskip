...
describe('HelpNavigation', () => {
  ...
  it('should render About tab first (hardcoded)', () => {
    render(
      <HelpNavigation sections={mockSections} activeSectionId="about" onNavigate={() => {}} />,
    );
  ...
  it('should render section icons when provided', () => {
    ...
    render(
      <HelpNavigation sections={sectionsWithIcon} activeSectionId="about" onNavigate={() => {}} />,
    );
