...
record NoaaSolarCycleEntry(
    ...
    public void validate() {
        ...
        if (solarFlux == null) {
            throw new InvalidApiResponseException("NOAA", "Missing required field: f10.7 (solar flux)");
        }
        ...
        if (sunspotNumber == null) {
            throw new InvalidApiResponseException("NOAA", "Missing required field: ssn (sunspot number)");
        }
        ...
        if (timeTag == null || timeTag.isBlank()) {
            throw new InvalidApiResponseException("NOAA", "Missing required field: time-tag");
        }
    }
}
