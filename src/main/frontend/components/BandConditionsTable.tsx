...
function BandConditionsTable({ bandConditions }: Props) {
  ...
  const sortedConditions = [...bandConditions].sort((a, b) => {
    const order = ['BAND_160M', 'BAND_80M', 'BAND_40M', 'BAND_30M', 'BAND_20M',
                   'BAND_17M', 'BAND_15M', 'BAND_12M', 'BAND_10M', 'BAND_6M'];
  ...
  return (
    <div className="band-conditions-table card card-elevated">
      <div className="card-header">
        <h3>📻 HF Band Conditions</h3>
        <p className="header-subtitle">Current propagation by amateur radio band</p>
      </div>
...
export default BandConditionsTable;
